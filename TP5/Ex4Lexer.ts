...
export class Ex4Lexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(Ex4Lexer._LITERAL_NAMES, Ex4Lexer._SYMBOLIC_NAMES, []);

	// @Override
	// @NotNull
	public get vocabulary(): Vocabulary {
		return Ex4Lexer.VOCABULARY;
	}
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(Ex4Lexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return Ex4Lexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return Ex4Lexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return Ex4Lexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return Ex4Lexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!Ex4Lexer.__ATN) {
			Ex4Lexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(Ex4Lexer._serializedATN));
		}

		return Ex4Lexer.__ATN;
	}
