...
import { FunctionCallRuleContext } from "./AlfParser";
import { VariableAttributionContext } from "./AlfParser";
import { FunctionCallAttributionContext } from "./AlfParser";
...
export interface AlfListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the `functionCallAttribution`
	 * labeled alternative in `AlfParser.attribution`.
	 * @param ctx the parse tree
	 */
	enterFunctionCallAttribution?: (ctx: FunctionCallAttributionContext) => void;
	/**
	 * Exit a parse tree produced by the `functionCallAttribution`
	 * labeled alternative in `AlfParser.attribution`.
	 * @param ctx the parse tree
	 */
	exitFunctionCallAttribution?: (ctx: FunctionCallAttributionContext) => void;
	 ...
	 * labeled alternative in `AlfParser.startstartstatementstatementstatementstatementstatementstatementdeclarationdeclarationtypetypetypevaluevaluevaluevalueexpressionexpressionexpressionexpressionexpressionexpressionexpressionattributionattributionlist_declarationvaluesfunction_declarationparameterreturn_functionreturn_functionfunction_call`.
	 * @param ctx the parse tree
	 */
